...
export const seoData = {
  '/': {
    ...
    intro: {
      ...
      zh: [
        'Plotlake 是一款以隐私为先的动画制作工具，完全在您的浏览器中运行。拖放 JPG、PNG、WebP、iPhone 的 HEIC/HEIF 照片，或 MP4/WebM/MOV 视频文件，裁剪所需片段，无需上传到服务器即可生成清晰的 GIF、动画 WebP 或 APNG。无水印、无需注册、无隐藏限制——仅通过 WebAssembly FFmpeg 进行快速本地处理。',
        '三种简单工作流：转格式可快速导出 GIF、WebP 或 APNG。平台适配可自动调整 Twitter、Discord、Slack、Telegram 或邮件等平台的设置，并推荐最佳输出格式。高级模式可完全控制画质、压缩、抖动和高级 GIF 选项。',
        '我们提供针对社交媒体平台优化的预设：一键优化 X（Twitter）、Discord（8MB）、Slack（5MB）、Telegram 和邮件（2MB）。选择 GIF 获得最佳兼容性，选择动画 WebP 获得比 GIF 小 60% 的文件，或选择 APNG 获得无损 PNG 质量。所有参数可调：抖动算法、循环次数、压缩调色板大小和填充颜色。',
        '支持现代格式：拖放整个文件夹批量导入按文件名排序的图片序列。iPhone 的 HEIC/HEIF 照片会自动转换。一键输出动画 WebP（比 GIF 更小，质量优秀）或 APNG（完整 PNG 质量，最适合文字/UI）。',
        '由于处理在本地进行，敏感内容永远不会离开您的设备。首次处理视频会下载并缓存约 30MB 的 FFmpeg 核心；之后，帧提取和编码保持快速。对于图片，每帧延迟控制和淡入淡出选项可在保持细节的同时让循环更流畅。',
        '为创作者打造：永久免费、无水印、即时下载。尝试图片或视频模式，选择平台预设（Twitter、Discord、Slack、Telegram、邮件），根据需要调整高级滤镜，并在任何地方分享您的动画。',
      ],
    },
    features: {
      en: [
      ...
      zh: [
        '100% 浏览器端处理——不上传任何内容，完美保护隐私敏感片段。',
        '无水印、无账户、无付费墙；导出默认保持干净。',
        '现代输出格式：动画 WebP（比 GIF 小 60%）和 APNG（无损 PNG 质量）。',
        'iPhone 就绪输入：支持 HEIC/HEIF + 文件夹拖放批量导入。',
        '平台预设：一键优化 Twitter、Discord、Slack、Telegram、邮件。',
        '支持图片（JPG、PNG、WebP、HEIC/HEIF）和视频（MP4、WebM、MOV、AVI、MKV）。',
        '预设：社交媒体、高质量（4K、100ms）、教程（清晰文字）、小文件。',
        '可自定义抖动算法（Bayer、Floyd-Steinberg、Sierra）和调色板大小。',
        '为稳定性优化的限制：约 100MB 图片，视频约 60 秒或约 300 帧。',
        '循环控制（无限/有限）、淡入淡出选项、帧延迟或基于 FPS 的时序。',
        '即时下载链接；FFmpeg 核心首次加载后缓存。',
      ],
    },
    faq: [
  ...
  '/gif-maker': {
    title: 'Free GIF Maker | No Watermark, No Signup | Plotlake',
    description: 'Create animated GIFs for free. Upload images or video, adjust speed, and download without watermarks. 100% private, browser-based processing.',
    h1: 'Free GIF Maker (Fast & Private)',
    intro: [
      'Plotlake is the best free GIF maker that runs entirely in your browser. Whether you need to convert a video snippet or combine photos into a loop, we handle it all locally without uploading your files.',
      'Our tool is fast, free, and puts no watermarks on your work. Perfect for social media, memes, and work demos.',
    ],
    features: [
      'Make GIFs from Images or Video.',
      'No watermark, ever.',
      'Fast browser-side processing.',
      'Control speed, size, and repeating loops.'
    ],
    faq: [
      { q: 'Is it free?', a: 'Yes, completely free.' },
      { q: 'Is there a watermark?', a: 'No watermark.' }
    ],
    relatedLinks: related('/'),
    ogImage: defaultOg,
  },
  '/make-gif': {
    title: 'Make a GIF Online | Fast & Easy | Plotlake',
    description: 'Make a GIF online in seconds. Drop your files and get a clean, high-quality GIF. No Watermark.',
    h1: 'Make a GIF Online',
    intro: [
      'Want to make a GIF quickly? Drag and drop your files here. We support images (JPG, PNG) and videos (MP4, MOV).',
      'Adjust the frame rate, crop the image, and optimize for file size. All for free.'
    ],
    features: ['Easy drag-and-drop.', 'Supports all major formats.', 'Instant download.'],
    faq: [{ q: 'How do I make a GIF?', a: 'Upload your media, adjust settings, click Generate.' }],
    relatedLinks: related('/'),
    ogImage: defaultOg,
  },
  '/create-gif': {
    title: 'Create GIF from Images or Video | Plotlake',
    description: 'Create custom GIFs for Discord, Twitter, and Slack. Free online tool with no watermark.',
    h1: 'Create GIF (Custom & Free)',
    intro: ['Create professional GIFs for your marketing or personal use. Plotlake gives you granular control over quality and size.'],
    relatedLinks: related('/'),
    ogImage: defaultOg,
  },
  '/video-to-gif-converter': {
    title: 'Video to GIF Converter (High Quality)',
    description: 'Convert video to GIF with high quality. Settings for FPS, size, and length. No watermark.',
    h1: 'Video to GIF Converter',
    intro: ['Convert your favorite video clips into lightweight, shareable GIFs. Compatible with MP4, MOV, and WebM.'],
    relatedLinks: related('/video-to-gif'),
    ogImage: defaultOg,
  },
  '/mp4-to-gif-converter': {
    title: 'MP4 to GIF Converter | Fast & Free',
    description: 'The best MP4 to GIF converter. Trim your clip and convert instantly in the browser.',
    h1: 'MP4 to GIF Converter',
    intro: ['Turn MP4 files into GIFs without strict file limits. Our browser-based converter is fast and secure.'],
    relatedLinks: related('/mp4-to-gif'),
    ogImage: defaultOg,
  },
  '/mov-to-gif': {
    title: 'MOV to GIF | Convert Apple Video to GIF',
    description: 'Convert MOV files (iPhone/Mac video) to GIF online. No upload needed.',
    h1: 'MOV to GIF Converter',
    intro: ['Easily convert MOV video files from your iPhone or Mac into universally compatible GIFs.'],
    relatedLinks: related('/video-to-gif'),
    ogImage: defaultOg,
  },
  '/webm-to-gif': {
    title: 'WebM to GIF | Convert Web Video',
    description: 'Convert WebM videos to GIF. Perfect for saving web animations.',
    h1: 'WebM to GIF Converter',
    intro: ['Turn efficient WebM videos into standard GIFs for compatibility with all platforms.'],
    relatedLinks: related('/video-to-gif'),
    ogImage: defaultOg,
  },
  '/avi-to-gif': {
    title: 'AVI to GIF | Legacy Video Support',
    description: 'Convert AVI files to GIF. Browser-based processing.',
    h1: 'AVI to GIF Converter',
    intro: ['Support for older AVI video formats. convert them to modern GIFs easily.'],
    relatedLinks: related('/video-to-gif'),
    ogImage: defaultOg,
  },
  '/mkv-to-gif': {
    title: 'MKV to GIF | Convert MKV Videos',
    description: 'Convert MKV video containers to GIF. Select your clip and convert.',
    h1: 'MKV to GIF Converter',
    intro: ['Directly convert MKV files to GIF without re-encoding to MP4 first.'],
    relatedLinks: related('/video-to-gif'),
    ogImage: defaultOg,
  },
  '/gif-cropper': {
    title: 'GIF Cropper | Crop Animated GIFs',
    description: 'Crop GIFs to remove borders or focus on the action. Free online tool.',
    h1: 'GIF Cropper',
    intro: ['Crop your animated GIFs to any aspect ratio. Remove watermarks or black bars easily.'],
    relatedLinks: related('/crop-gif'),
    ogImage: defaultOg,
  },
  '/gif-resizer': {
    title: 'GIF Resizer | Change Dimensions',
    description: 'Resize GIFs (Canvas size) without losing animation. Add padding or change aspect ratio.',
    h1: 'GIF Resizer',
    intro: ['Resize your GIF canvas. Add padding to make it square for Instagram or Discord.'],
    relatedLinks: related('/gif-canvas'),
    ogImage: defaultOg,
  },
  '/resize-gif': {
    title: 'Resize GIF | Online Tool',
    description: 'Resize animated GIFs online. Fast and free.',
    h1: 'Resize GIF',
    intro: ['Simple tool to resize your GIF dimensions or canvas.'],
    relatedLinks: related('/gif-canvas'),
    ogImage: defaultOg,
  },
  '/gif-text-editor': {
    title: 'GIF Text Editor | Add Captions',
    description: 'Add text to GIFs. Edit font, color, and position.',
    h1: 'GIF Text Editor',
    intro: ['Add captions, subtitles, or watermarks to your GIFs with our easy text editor.'],
    relatedLinks: related('/add-text-to-gif'),
    ogImage: defaultOg,
  },
  '/caption-gif': {
    title: 'Caption GIF | Meme Maker',
    description: 'Add captions to GIFs to create memes. Free online tool.',
    h1: 'Caption GIF',
    intro: ['Turn any GIF into a meme by adding top/bottom text or subtitles.'],
    relatedLinks: related('/add-text-to-gif'),
    ogImage: defaultOg,
  },
  '/meme-generator': {
    title: 'GIF Meme Generator | Free',
    description: 'Make GIF memes online. Add text to animated GIFs.',
    h1: 'GIF Meme Generator',
    intro: ['The fastest way to create animated memes. No watermark, just fun.'],
    relatedLinks: related('/add-text-to-gif'),
    ogImage: defaultOg,
  },
  '/gif-to-mp4': {
    title: 'GIF to MP4 Converter | Convert Animation to Video',
    description: 'Convert GIF to MP4 video for Instagram and TikTok. Smooth playback.',
    h1: 'GIF to MP4 Converter',
    intro: [
      'Convert your GIFs into MP4 videos. Perfect for sharing on platforms that prefer video like Instagram, TikTok, and YouTube.',
      'We use H.264 encoding for maximum compatibility.'
    ],
    features: ['Convert GIF to MP4.', 'Optimized for social media.', 'Browser-based privacy.'],
    faq: [{ q: 'Can I upload a GIF?', a: 'Yes, upload your GIF to the Image to MP4 tool.' }],
    relatedLinks: related('/image-to-mp4'),
    ogImage: defaultOg,
  },
};
